...
class TestBatteryHardware(unittest.TestCase):
    ...
    #WINDOWS
    @patch("tracker.core.battery_hardware.platform.system", return_value="Windows")
    @patch("tracker.core.battery_hardware.BatteryHardware._win_get_status")
    ...
    @patch("tracker.core.battery_hardware.platform.system", return_value="Windows")
    @patch("tracker.core.battery_hardware.subprocess.run")
    ...
    @patch("tracker.core.battery_hardware.platform.system", return_value="Linux")
    @patch("tracker.core.battery_hardware.psutil.sensors_battery")
    ...
    @patch("tracker.core.battery_hardware.platform.system", return_value="Darwin")
    @patch("tracker.core.battery_hardware.subprocess.run")
